please link it in the header : <?php
...
// Update ADMINURL to match your actual directory structure
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div id="wrapper">
        <nav class="navbar header-top fixed-top navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#">TUNISIANFARM</a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <?php if (isset($_SESSION['adminname'])) : ?>
                        <ul class="navbar-nav side-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link"
                                   href="<?php echo ADMINURL; ?>/categories-admins/show-categories.php"
